                ...
                <tr>
                   ...
                   <td style="text-align: center;"><?php if($rows->hot==1): ?><span class="fa fa-check"></span><?php endif; ?></td>
                    <td style="text-align:center;display: flex;">
                        <a href="index.php?controller=products&action=update&id=<?php echo $rows->id; ?> "class="btn btn-primary"style= "width: 70px;background:#0033FF;font-size: 16px;">Update</a>&nbsp;
                        <a href="index.php?controller=products&action=delete&id=<?php echo $rows->id; ?>" onclick="return window.confirm('Are you sure?');"class="btn btn-primary" style= "width: 70px;background: #EE0000;font-size: 16px;margin-left: 5px;" >Delete</a>
                    </td>
                </tr>
            	<?php endforeach; ?>
            </table>
