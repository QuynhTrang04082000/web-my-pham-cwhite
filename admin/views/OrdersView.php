...
<div class="col-md-12">    
     <div class="col-lg-3 pull-right text-right"style="margin-left: 360px;">
                <select class="form-control" onchange="location.href = 'index.php?controller=products&action=orders=<?php echo $order; ?>&order='+this.value;">
                  <option value="0">Sắp xếp</option>
                  <option value="dateAsc">ngày gần </option>
                  <option value="dateDesc">ngày cũ</option>
                </select>
              </div>
