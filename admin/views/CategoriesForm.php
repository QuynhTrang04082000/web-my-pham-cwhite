    ...
    <div class="panel panel-primary">
        ...
        <form method="post" action="<?php echo $action; ?>">
            ...
            <div class="row" style="margin-top:5px;">
                ...
                <div class="col-md-10">
                    <input type="checkbox" <?php if(isset($record->displayhomepage)&&$record->displayhomepage==1) ?> name="displayhomepage" id="displayhomepage"><label for="displayhomepage">&nbsp;&nbsp; Hiển thị danh mục này ở trang chủ</label>
                </div>
            </div>
            <!-- end rows -->
            <!-- rows -->
