...
<div class="top">
  <div class="row">
    ...
    <div class="col-xs-12 col-md-6 info">
      ...
      <p itemprop="price" class="price-box product-price-box"> <span class="special-price"> <span class="price product-price" style="color: red;"><?php echo number_format($record->price-($record->price*$record->discount)/100); ?>₫ </span></span></p>
    </p>
    <div class="middle" style="padding-top: -5px;">
  <?php echo $record->description; ?>
  
</div>
 <p class="vendor"> <b>Thương Hiệu:</b>&nbsp; <span> <?php echo $this->getCategory($record->category_id); ?> </span></p>
    <a href="index.php?controller=cart&action=create&id=<?php echo $record->id; ?>" class="btn btn-primary" style="height: 35px;width: 140px;font-size: 15px;margin-top: 20px;
    background: #252525;color: white;">Cho vào giỏ hàng</a>
    <!-- rating -->
    <div style="border:1px solid #dddddd; margin-top: 15px;">
      ...
      <table style="width: 100%;">
        <tr>
          ...
          <td><span class="label label-primary"><?php echo $this->getStar($record->id,1) ?></span></td>
        </tr>
        <tr>
          <td style="width: 80%; padding-left: 10px;"><img src="assets/frontend/images/star.jpg"> <img src="assets/frontend/images/star.jpg"></td>
          <td><span class="label label-warning"><?php echo $this->getStar($record->id,2) ?></span></td>
        </tr>
        <tr>
          ...
          <td><span class="label label-danger"><?php echo $this->getStar($record->id,3) ?></span></td>
        </tr>
        <tr>
          ...
          <td><span class="label label-info"><?php echo $this->getStar($record->id,4) ?></span></td>
        </tr>
        <tr>
          ...
          <td><span class="label label-success"><?php echo $this->getStar($record->id,5) ?></span></td>
        </tr>
      </table>
      <br>
    </div>
...
<div class="middle" style="padding-top: 40px;"><h4>THÔNG TIN SẢN PHẨM</h4> 
  
  <p style="margin-top: 10px;"><?php echo $record->content; ?></p>
</div>