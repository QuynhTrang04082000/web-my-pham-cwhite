<?php 
 ...
 ?>
<div class="template-customer" style="font-size: 16px;">
          <h1>Đăng nhập tài khoản</h1>
          <?php if(isset($_GET["notify"])&&$_GET["notify"]=="success"): ?>
            <p style="color: red;">dang ky thanh cong</p>
            <?php   else: ?>
            ...
            <div class="col-md-6">
              <div class="wrapper-form">
                <form method='post' action="index.php?controller=account&action=loginPost">
                  ...
                  <p class="title" ><span><b style="font-size: 20px;">Đăng nhập tài khoản</b></span></p>
                  ...
                  <input type="submit" class="button" value="Đăng nhập" style="background: #252525;width: 200px;margin-top: 20px;margin-left: 60px;">
                </form>
              </div>
            </div>
            <div class="col-md-6">
              <div class="wrapper-form">
                <p class="title"><span><b style="font-size: 20px;">Tạo tài khoản mới</b> </span></p>
                ...
                <a href="index.php?controller=account&action=register" class="button"style="background: #252525;width: 160px;margin-top: 20px;margin-left: 60px;">Đăng ký</a> </div>
            </div>
          </div>
        </div>