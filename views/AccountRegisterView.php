<?php 
 ...
 <div class="template-customer" style="font-size: 16px;">
          ...
          <?php   if(isset($_GET["notify"])&&$_GET["notify"]=="exists"): ?>
            <p style="color: red">email da ton tai </p>
            <?php   else: ?>
          ...
          <div class="row" style="margin-top:50px;">
            <div class="col-md-6">
              <div class="wrapper-form">
                <form method='post' action="index.php?controller=account&action=registerPost">
                  ...
                  <div class="form-group">
                    <input type="submit" class="button" value="Đăng ký" style="background: #252525;">
                  </div>
            ...
            <div class="col-md-6">
              <div class="wrapper-form">
                ...
                <a href="index.php?controller=account&action=login" class="button" style="background: #252525">Đăng nhập</a> </div>
            </div>
          </div>
        </div>