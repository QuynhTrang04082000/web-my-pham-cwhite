              ...
              <table class="table table-cart">
                <thead>
                  <tr>
                    ...
                    <th style="width: 50px;"><i class="ti-close"></th>
                  </tr>
                </thead>
                <tbody>
                <?php foreach($_SESSION["Wishlist"] as $product): ?>
                  <tr>
                    ...
                    <td><a href="index.php?controller=products&action=detail&id=<?php echo $product['id']; ?>" style="font-size: 14px;"><?php echo $product['name']; ?></a></td>
