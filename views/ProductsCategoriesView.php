...
<div class="special-collection" >
         <div class="tabs-container">
            <div class="row" style="margin-top:10px;">
              ...
              <div class="col-lg-3 pull-right text-right"style="margin-left: 360px;">
            ...
            <div id="content-tabb1" class="content-tab content-tab-proindex" style="display:none">
              <div class="clearfix">                 
                ...
                <div class="col-xs-6 col-md-3 col-sm-6 ">
                  ...
                  <div class="product-grid" id="product-1168979" style="height: 370px; overflow: hidden;">
                    ...
                    <div class="info">
                     ...
                     <!--  <p class="price-box"> <span class="special-price"> <span class="price product-price" style=" margin-top: 50px; text-decoration:line-through;"> <?php //echo number_format($rows->price); ?></span> ₫ </span> </p> -->
